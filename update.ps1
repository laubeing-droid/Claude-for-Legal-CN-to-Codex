...
.DESCRIPTION
  ...
  2. MCP 连接器检查（委托给 legal-cn-mcp-hub 仓库）
  3. 验证安装完整性
#>
...
$McpRepoUrl = 'https://github.com/laubeing-droid/legal-cn-mcp-hub.git'
...
Write-Host 'MCP 连接器由 legal-cn-mcp-hub 独立管理。' -ForegroundColor Cyan

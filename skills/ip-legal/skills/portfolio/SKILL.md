...
- **中国商标：** 注册商标有效期十年，自核准注册之日起计算（《中华人民共和国商标法》第39条 `[法条原文]`）。续展注册应在期满前十二个月内办理，宽展期为六个月（《中华人民共和国商标法》第40条 `[法条原文]`）。宽展期内续展需缴纳迟延费。
  - **商标使用义务：** 注册商标连续三年不使用，任何单位或个人可向国家知识产权局申请撤销（《中华人民共和国商标法》第49条 `[法条原文]`，俗称"撤三"）。不同于美国§8使用声明制度——中国没有定期使用声明制度，而是被动撤三制度。保留使用证据对于防御撤三至关重要。
...
**商业使用 / 撤三风险（仅商标）**
- 《中华人民共和国商标法》第49条 `[法条原文]` 规定任何人在注册商标连续三年不使用时可申请撤销。标注距注册日已超过三年且使用状态不确定的商标——应在收到撤三通知前整理使用证据。
